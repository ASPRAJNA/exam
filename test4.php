...
$sql2="SELECT COUNT(ENTRY) as track FROM result WHERE NAME='".$_SESSION["user"]."'AND TEST='TEST 4'";
...
if($ent==0){
$sql="SELECT * from test4 where QNO='".$id."'";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $date_t=date("d/m/y");
    if($id>=26){
      $sql = "INSERT INTO result (NAME, TEST, SCORE,DATE_E) VALUES ('".$_SESSION['user']."', 'TEST 4', '".$track."','".$date_t."')";
...
?><br>
  <br>
  <div class="bk">
    <h1 style="color:9744be;text-align:center;font-family:'Yeseva One'">TEST 4</h1><br><br>
    <div class="container">
